      ...
      <div className='flex flex-wrap justify-between py-24 gap-14'>
        <div className='max-w-[50%]'>
          ...
          <div className='flex flex-wrap justify-between pt-[66px]'>
            ...
            <strong className='flex items-center gap-2 pb-5 text-base-text text-[16px] font-[400] w-[50%] '><i className='bg-base-text text-white rounded-full p-2' ><Package size={16} weight='fill' /></i> Embalagem mantém o café intacto </strong>
            <strong className='flex items-center gap-2 pb-5 text-base-text text-[16px] font-[400] w-[50%] '><i className='bg-yellow text-white rounded-full p-2' ><Timer size={16} weight='fill' /></i> Entrega rápida e rastreada </strong>
            <strong className='flex items-center gap-2 pb-5 text-base-text text-[16px] font-[400] w-[50%] '><i className='bg-purple text-white rounded-full p-2' ><Coffee size={16} weight='fill' /></i> O café chega fresquinho até você </strong>
          </div>

        </div>
        <img src="../../src/assets/imagem.svg" className='max-w-full min-w-[480px]' alt="" />
      </div>
