...
export const CardProduct = () => {
  return (
    <div className='bg-base-card flex flex-col items-center rounded-tr-[36px] rounded-[8px] rounded-bl-[36px] rounded-2 px-6 py-5 lg:max-w-[22%] justify-center break-normal'>
