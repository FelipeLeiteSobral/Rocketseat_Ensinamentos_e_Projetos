...
export const ButtonSelectQuantity = () => {
  return (
    <button className='bg-base-button flex items-center justify-center p-2 h-[38px] rounded-[6px] font-roboto font-[400] text-[16px] transition-all ease-in-out duration-200 relative gap-2'>
        <i>
